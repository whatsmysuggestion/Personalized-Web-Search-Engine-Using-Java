...
<div id="templatemo_header">
    ...
    <div id="templatemo_menu">
        <ul>
			...
			<li><a href="history.jsp">MyHistory</a></li>
...
-webkit-border-radius: 10px ; width:800px;  margin: 0px 0px;">
	...
	try{
			...
			String sql1="select Distinct(tid) from frequent  order by tid DESC";
 ...
 %>
						...
						<tr bgcolor="#FF0000">
							<th width="100" height="58">UserId</th>
							<th width="100">Transaction Id</th>
							
							<th width="150">URLNameFrom</th>
							<th width="150">URLNameTo</th
							
							><th width="150">VisitCount </th>
...
String uid = (String)session.getAttribute("uid");
 	...
 	ResultSet rs7=null;
				...
				Connection con3=databasecon.getconnection();
					...
					String qry3="select * from frequent where tid='"+mytidtemp[i]+"' and uid='"+uid+"'";
						...
						%>
							<tr bgcolor="">
								<td bgcolor=""><strong><%=rs7.getString("uid")%></strong></td>
								<td bgcolor=""><strong><%=rs7.getString("tid")%></strong></td>
								<td bgcolor=""><strong><%=rs7.getString("psearch")%></strong></td>
								<td bgcolor=""><strong><%=rs7.getString("nsearch")%></strong></td>
								<td bgcolor=""><strong><%=rs7.getString("count")%></strong></td>
