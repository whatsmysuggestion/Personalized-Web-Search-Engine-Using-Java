...
String uid = (String)session.getAttribute("uid");
 	...
 	ResultSet rs7=null;
				...
				Connection con3=databasecon.getconnection();
					...
					String qry3="select * from transaction where tid='"+mytidtemp[i]+"' and uid='"+uid+"'";
						...
						%>
							<tr bgcolor="">
								<td bgcolor=""><strong><%=rs7.getString("uid")%></td>
 ...
 %>
	  ...
	  <br>
      <p align="right"><strong><font size="4"><a href="frequent.jsp">Click here to View Frequent Visit:</a></font></strong></p>
