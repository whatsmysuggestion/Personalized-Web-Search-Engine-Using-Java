...
<%
		...
		String urlname=null,title=null,description=null,image=null,iname=null,category=null;
		Statement st = null;
		ResultSet rs1=null;
		int iid=0,count=0;
	...
	try{
			...
			String sql1="select max(iid) from content";
	...
	while (files.hasMoreElements()) 
	{
		...
		if(paramname != null)
		{
			...
			PreparedStatement ps=con.prepareStatement("INSERT INTO content VALUES(?,?,?,?,?,?,?,?)");
       ...
       if(f == 0)
		...
		else if(f == 1)
		{
			...
			{
				response.sendRedirect("content.jsp?message=fail");
			}
